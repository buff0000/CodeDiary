 ...
 */
public class WQ_EmitLog {

    private static Logger logger = LoggerFactory.getLogger(WQ_EmitLog.class);
    ...
    public static void emit(List<String> messages) throws IOException {
        ...
        channel.queueDeclare(ConstantMQInfo.QUEUE_NAME_3,true,false,false,null);
        channel.queueDeclare(ConstantMQInfo.QUEUE_NAME_4,true,false,false,null);
