 ...
 */
public class FilterMainThread {
    private static Logger logger = LoggerFactory.getLogger(FilterMainThread.class);
...
//        # (hash) can substitute for zero or more words.
        ...
        channel.queueBind(queueName, ConstantMQInfo.EXCHANGE_NAME_3, "main_thread.*.*");
