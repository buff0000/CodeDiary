...
public class FilterDaoService {
    private static Logger logger = LoggerFactory.getLogger(FilterDaoService.class);
...
//        # (hash) can substitute for zero or more words.
        ...
        channel.queueBind(queueName, ConstantMQInfo.EXCHANGE_NAME_3, "*.*.dao");
        channel.queueBind(queueName, ConstantMQInfo.EXCHANGE_NAME_3, "*.service");
